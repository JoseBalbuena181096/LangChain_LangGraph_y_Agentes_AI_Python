...
class CustomMultiQueryRetriever(BaseRetriever):
    ...
    def _get_relevant_documents(
        ...
        # Generar consultas alternativas
        queries = self._generate_queries(query)
        
        # Recuperar documentos para cada consulta
        all_docs = []
        seen_content = set()
        ...
        return all_docs[:10]  # Limitar a 10 documentos más relevantes
    ...
    def _generate_queries(self, query: str) -> List[str]:
        ...
        try:
            ...
            # Parsear las consultas generadas
            queries = [query]  # Incluir la consulta original
            for line in queries_text.split('\n'):
                line = line.strip()
                if line and line not in queries:
                    # Limpiar números y guiones al inicio
...
class VectorRAGSystem:
    ...
    def _load_vectorstore(self):
        ...
        try:
            ...
            # Crear CustomMultiQueryRetriever
