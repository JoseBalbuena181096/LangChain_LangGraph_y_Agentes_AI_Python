...
agent_executor = AgentExecutor.from_agent_and_tools(
    ...
    max_iterations=10, # Limitar las iteraciones para evitar bucles
)
...
def process_latest_email():
    try:
        ...
        return f"Error al procesar el email: {str(e)}"


# Ejecutar el ultimo email
if __name__ == "__main__":
    response = process_latest_email()
    print("\nRespuesta del agente:" + "="*50)
    print("\n" + response)
    print("="*50 + "\n")
